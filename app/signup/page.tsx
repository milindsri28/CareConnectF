      ...
      <main className="flex-1 flex flex-col md:flex-row items-center justify-center p-6 gap-8">
        <div className="w-full max-w-md">
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="profileImage" className="text-white text-lg">
                Profile Picture (Optional)
              </label>
              <FileUpload onUpload={handleProfileImageUpload} type="profile" className="bg-white/10 p-3 rounded-md" />
            </div>

            <Button
              type="submit"
              className="w-full bg-[#34a353] hover:bg-[#2a8442] text-white rounded-full"
              disabled={isLoading}
            >
